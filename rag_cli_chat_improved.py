...
def main():
    print("Welcome to the Belle II RAG CLI Chatbot (Improved Version)!")
    print("Type 'exit' to quit, 'sources' to see retrieved sources.")
    print("=" * 60)
    ...
    qa_pairs = load_qa_pairs("belle2_qa_detailed_full.jsonl")
